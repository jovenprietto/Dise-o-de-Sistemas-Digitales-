...
REM
REM Generated by Vivado on Sun Nov 09 22:24:43 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj procesador_top_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj procesador_top_tb_vlog.prj -log xvlog.log
