...
REM
REM Generated by Vivado on Tue Sep 23 23:19:11 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_CODIGO_CORRECTO_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_CODIGO_CORRECTO_vlog.prj -log xvlog.log
